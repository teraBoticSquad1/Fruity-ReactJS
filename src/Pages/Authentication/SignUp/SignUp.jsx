...
const SignUp = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log(data);
        fetch('https://fruity-mongoose.vercel.app/api/v1/auth/register', {
            method: "POST",
    ...
    return (
        <section className="font-poppins my my-20 py-7">
            <div className="max-w-6xl px-1 mx-auto lg:px-6 ">
                <div className="flex flex-col items-center h-full md:flex-row">
                    <div className="flex items-center justify-center w-full h-screen px-1 lg:w-3/6 md:mx-auto md:w-3/5 lg:px-16 xl:px-12">
                        <div className=" w-full p-10 bg-white shadow-lg h-100">
                            ...
                            <form action="" onSubmit={handleSubmit} className="mt-6">
                                ...
                                <div>
                                    <select value={role} onChange={e=>roleChange(e.target.value)} id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 mt-5">
                                ...
                                <p className="mt-5 text-sm text-gray-700 mb-7 ">
