...
const About = () => {
    ...
    return (
        <div className="my-10">
            ...
            <section className="flex items-center py-10 lg:py-24 bg-stone-50 font-poppins">
                <div className="justify-center flex-1 px-4 py-6 mx-auto max-w-7xl lg:py-4 md:px-6">
                    <div className="mb-10 text-center">
                        <span
                            className="block mb-4 text-xs font-semibold leading-4 tracking-widest text-center text-orange-500 uppercase">
                            Team
                        </span>
                        <h1 className="text-3xl font-bold capitalize"> Our Perfect Team </h1>
                    </div>
                    <div className="grid grid-cols-1 gap-4 lg:gap-8 sm:gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <a className="flex justify-center p-5 text-center flex-col flex-wrap mb-0 overflow-hidden rounded lg:flex-row border" href="#">
                            <div
                                className="inline-block w-full mb-3 overflow-hidden text-xs text-white md:rounded-full h-96 sm:w-64 sm:h-64">
                            ...
                            <div className="relative flex self-center flex-1 ">
                                <div className='mx-auto'>
                                    <h2 className="mb-2 text-2xl font-bold dark:text-gray-300">Harry Singh</h2>
                                    <p className="mb-4 text-sm font-medium text-orange-500 dark:text-orange-400">Director</p>
                        ...
                        <a className="flex justify-center p-5 text-center flex-col flex-wrap mb-0 overflow-hidden rounded lg:flex-row border" href="#">
                            <div
                                className="inline-block mb-3 overflow-hidden text-xs text-white bg-orange-500 md:rounded-full h-96 sm:w-64 sm:h-64">
                                <img className="object-cover w-full h-full transition-all hover:scale-110"
