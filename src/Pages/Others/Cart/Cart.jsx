...
const Cart = () => {
    return (
        <section class="py-24 bg-gray-100 font-poppins dark:bg-gray-100">
                ...
                <div class="p-6 mb-8 border bg-gray-50 dark:bg-gray-800 dark:border-gray-800">
                    ...
                    <div class="py-4 mb-8 border-t border-b border-gray-200 dark:border-gray-700">
                        <div class="flex flex-wrap items-center mb-6 -mx-4 md:mb-8">
                            ...
                            <div class="hidden px-4 lg:block lg:w-2/12">
                                <p class="text-lg font-bold text-yellow-500 dark:text-gray-400">$100.00</p>
                            ...
                            <div class="w-auto px-4 text-right md:w-1/6 lg:w-2/12 ">
                                <p class="text-lg font-bold text-yellow-500 dark:text-gray-400">$99.00</p>
                            </div>
                        </div>
                        <div class="flex flex-wrap items-center mb-6 -mx-4 md:mb-8">
                            <div class="w-full px-4 mb-6 md:w-4/6 lg:w-6/12 md:mb-0">
                ...
                <div class="flex flex-wrap justify-between">
                    <div class="w-full px-4 mb-4 lg:w-1/2 ">
                        <div class="flex flex-wrap items-center gap-4">
                            ...
                            <button
                                class="inline-block w-full px-8 py-4 font-bold text-center text-gray-100 bg-yellow-500 rounded-md lg:w-32 hover:bg-yellow-600">Apply</button>
                        </div>
                    </div>
                    <div class="w-full px-4 mb-4 lg:w-1/2 ">
                        <div class="p-6 border border-yellow-100 dark:bg-gray-900 dark:border-gray-900 bg-gray-50 md:p-8">
                            ...
                            <div class="flex items-center justify-between ">
                                <button
                                    class="block w-full py-4 font-bold text-center text-gray-100 uppercase bg-yellow-500 rounded-md hover:bg-yellow-600">Checkout</button>
                            </div>
                        </div>
                    </div>
                </div>
