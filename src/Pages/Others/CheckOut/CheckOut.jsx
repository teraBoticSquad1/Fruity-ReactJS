        ...
        <section>
            ...
            <div className='container flex justify-around'>
                ...
                {/* <div id="accordion-collapse" data-accordion="collapse">
                    ...
                    <button type="submit" className="py-3 px-5 my-5 text-sm font-medium text-center text-black rounded-lg bg-orange-300 bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
                </div> */}
