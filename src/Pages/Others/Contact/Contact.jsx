        ...
        <section>
            ...
            <section className="bg-white my-10">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md border">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold  text-gray-900 ">Get A Quote</h2>

                    <form action="#" className="space-y-8 ">
                        <div className='grid grid-cols-6 gap-6'>
                            <div className='col-span-6 sm:col-span-3'>
                            <div>
                            <label for="website-admin" className="block mb-2 text-sm font-medium text-gray-900 dark:text-orange-500">Username</label>
                            <div className="flex">
                        ...
                        <label for="checkbox-1" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-900">Save my name, email, and website in this browser for the next time I comment.</label>
                        </div>
                        <button type="submit" className="py-3 px-5 mx-auto text-sm font-medium text-center text-black rounded-lg bg-orange-300 bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
                    </form>
                </div>
            </section>
            <div className='my-10'>
